...
st.set_page_config(layout="centered", page_title="HOMEPAGE")
...
st.markdown("<h2 style='text-align: center; font-family: Verdana, sans-serif; padding: 20px;'>app functionality: </h2>", unsafe_allow_html=True)
